 ...
 */
final class Version20190218200231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, banned TINYINT(1) NOT NULL, email VARCHAR(255) NOT NULL, is_visible TINYINT(1) NOT NULL, sub_date DATE NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, confirm_token VARCHAR(255) DEFAULT NULL, user_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vendor (id INT NOT NULL, district_id INT DEFAULT NULL, zipcode_id INT DEFAULT NULL, locality_id INT DEFAULT NULL, contact_mail VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, vat VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, door_number VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, INDEX IDX_F52233F6B08FA272 (district_id), INDEX IDX_F52233F6E4C7FA21 (zipcode_id), INDEX IDX_F52233F688823A92 (locality_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
