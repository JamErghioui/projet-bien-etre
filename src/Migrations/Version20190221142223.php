 ...
 */
final class Version20190221142223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, banned TINYINT(1) NOT NULL, email VARCHAR(255) NOT NULL, sub_date DATE NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, confirm_token VARCHAR(255) DEFAULT NULL, user_type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
