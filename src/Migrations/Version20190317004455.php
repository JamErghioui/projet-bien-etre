 ...
 */
final class Version20190317004455 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, banner_image_id INT DEFAULT NULL, description LONGTEXT NOT NULL, highlight TINYINT(1) NOT NULL, name VARCHAR(255) NOT NULL, validity TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_64C19C13F9CEB4E (banner_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, profile_image_id INT DEFAULT NULL, banned TINYINT(1) NOT NULL, email VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\', sub_date DATE NOT NULL, password VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, confirm_token VARCHAR(255) DEFAULT NULL, user_type VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649C4CF44DC (profile_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE image (id INT AUTO_INCREMENT NOT NULL, vendor_id INT DEFAULT NULL, image_filename VARCHAR(255) NOT NULL, url VARCHAR(255) DEFAULT NULL, image_path VARCHAR(255) DEFAULT NULL, INDEX IDX_C53D045FF603EE73 (vendor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FF603EE73 FOREIGN KEY (vendor_id) REFERENCES vendor (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image DROP FOREIGN KEY FK_C53D045FF603EE73');
